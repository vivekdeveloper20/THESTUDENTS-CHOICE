      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            className="bg-white rounded-3xl border border-gray-100 shadow-[0_20px_60px_rgba(110,0,224,0.08)] p-8">
            ...
            <div className="mb-8">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-bold text-[#6E00E0]">{formatINR(loanAmount)}</span>
              </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-bold text-[#6E00E0]">{interestRate}%</span>
              </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-bold text-[#6E00E0]">{tenure} Years</span>
              </div>
            ...
            <Link href="/contact-us?type=consultation"
              className="block w-full text-center bg-gradient-to-r from-[#6E00E0] to-[#6f1ed0] text-white font-bold py-4 rounded-2xl hover:opacity-90 transition-all hover:scale-[1.02] shadow-lg shadow-purple-200">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            ...
            {/* EMI Card */}
            <div className="bg-gradient-to-br from-[#6E00E0] to-[#6f1ed0] rounded-3xl p-8 text-white text-center shadow-[0_20px_50px_rgba(110,0,224,0.3)]">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-xl font-extrabold text-[#6E00E0]">{formatINR(Math.round(totalInterest))}</p>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="relative w-20 h-20 flex-shrink-0">
                  <svg viewBox="0 0 36 36" className="w-20 h-20 -rotate-90">
                    ...
                    <circle cx="18" cy="18" r="15.915" fill="none" stroke="#6E00E0" strokeWidth="3.5"
                      strokeDasharray={`${(loanAmount / totalPayment * 100).toFixed(1)} 100`} />
                  </svg>
                  <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-[#6E00E0]">
                    {(loanAmount / totalPayment * 100).toFixed(0)}%
                  </span>
                </div>
                <div className="text-sm space-y-2">
                  <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-[#6E00E0]"></span> Principal: {(loanAmount / totalPayment * 100).toFixed(1)}%</div>
