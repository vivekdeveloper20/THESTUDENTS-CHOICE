...
import { WhySingaporeTopChoiceSection } from './WhySingaporeTopChoiceSection';
import { SingaporePopularUniversitiesSection } from './SingaporePopularUniversitiesSection';
...
export interface StudySingaporePageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudySingaporePage(p: StudySingaporePageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally recognised universities, industry-focused education, modern city life, and strong global career opportunities in one of Asia&apos;s leading innovation and business hubs.
              </p>
              <Link
                href="/singapore-universities"
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'NUS ranked #8 & NTU ranked #15 globally' },
                    { icon: '🌏', text: "Asia's #1 financial & business hub" },
                    { icon: '🛡️', text: 'One of the world\'s safest cities' },
                    { icon: '🗣️', text: 'English-medium education system' },
                    { icon: '🤝', text: '65,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  <strong>NUS is ranked #8 in the world</strong> and NTU #15 — making Singapore home to <strong>two of the world&apos;s top 20 universities</strong>, both offering world-class programs in English.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Singapore Top Choice ──────────────────────────── */}
      <WhySingaporeTopChoiceSection />
      ...
      {/* ── Singapore Popular Universities ────────────────────────────── */}
      <SingaporePopularUniversitiesSection />
