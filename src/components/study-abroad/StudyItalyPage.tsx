...
import { WhyItalyTopChoiceSection } from './WhyItalyTopChoiceSection';
import { ItalyPopularUniversitiesSection } from './ItalyPopularUniversitiesSection';
...
export interface StudyItalyPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyItalyPage(p: StudyItalyPageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally respected universities, affordable education, rich cultural experiences, and career-focused programs in one of Europe's most iconic study destinations.
              </p>

              <Link
                href="/italy-universities"
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to Politecnico & Bologna' },
                    { icon: '🎨', text: 'Fashion, Design & Architecture hub' },
                    { icon: '🇪🇺', text: 'Gateway to Europe & Schengen' },
                    { icon: '💡', text: 'Affordable tuition & living costs' },
                    { icon: '🤝', text: '100,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Italy is home to the <strong>University of Bologna</strong>, founded in 1088 — the <strong>oldest university in the world</strong> — and remains a global leader in design and architecture.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Italy Top Choice ──────────────────────────── */}
      <WhyItalyTopChoiceSection />
      ...
      {/* ── Italy Popular Universities ────────────────────────────── */}
      <ItalyPopularUniversitiesSection />
