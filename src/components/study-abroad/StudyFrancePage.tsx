...
import { WhyFranceTopChoiceSection } from './WhyFranceTopChoiceSection';
import { FrancePopularUniversitiesSection } from './FrancePopularUniversitiesSection';
...
export interface StudyFrancePageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyFrancePage(p: StudyFrancePageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally ranked universities, industry-focused education, excellent post-study opportunities, and a high-quality student lifestyle in one of the world's most welcoming study destinations.
              </p>

              <Link
                href="/france-universities"
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to HEC Paris & Sorbonne' },
                    { icon: '🚀', text: '2 years post-study work visa' },
                    { icon: '🇪🇺', text: 'Gateway to Europe & Schengen' },
                    { icon: '💡', text: 'Business, Fashion & Luxury hub' },
                    { icon: '🤝', text: '400,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  France welcomes over <strong>400,000 international students</strong> annually and is home to <strong>world-leading business schools</strong> like HEC Paris, ESSEC, and INSEAD.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why France Top Choice ──────────────────────────── */}
      <WhyFranceTopChoiceSection />
      ...
      {/* ── France Popular Universities ────────────────────────────── */}
      <FrancePopularUniversitiesSection />
