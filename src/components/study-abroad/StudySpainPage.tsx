...
import { WhySpainTopChoiceSection } from './WhySpainTopChoiceSection';
import { SpainPopularUniversitiesSection } from './SpainPopularUniversitiesSection';
...
export interface StudySpainPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudySpainPage(p: StudySpainPageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to IE & ESADE — top global business schools' },
                    { icon: '💶', text: 'Affordable tuition vs. UK, Germany & France' },
                    { icon: '🌐', text: 'Gateway to Europe & Latin America' },
                    { icon: '☀️', text: 'Vibrant cities — Barcelona, Madrid, Valencia' },
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Spain is home to <strong>IE Business School</strong>, consistently ranked among the <strong>world&apos;s top business schools</strong>, and attracts over 200,000 international students every year.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Spain Top Choice ──────────────────────────── */}
      <WhySpainTopChoiceSection />
      ...
      {/* ── Spain Popular Universities ────────────────────────────── */}
      <SpainPopularUniversitiesSection />
