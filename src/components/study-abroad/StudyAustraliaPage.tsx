...
import { WhyAustraliaTopChoiceSection } from './WhyAustraliaTopChoiceSection';
import { AustraliaPopularUniversitiesSection } from './AustraliaPopularUniversitiesSection';
...
export interface StudyAustraliaPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyAustraliaPage(p: StudyAustraliaPageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to Melbourne, ANU & Sydney' },
                    { icon: '🚀', text: '2-6 years post-study work visa' },
                    { icon: '🌏', text: 'Multicultural & welcoming society' },
                    { icon: '💡', text: 'Industry-focused education' },
                    { icon: '🤝', text: '700,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Australia hosts over <strong>700,000 international students</strong> annually and offers <strong>2-6 years post-study work opportunities</strong> for eligible graduates.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Australia Top Choice ──────────────────────────── */}
      <WhyAustraliaTopChoiceSection />
      ...
      <AustraliaPopularUniversitiesSection />
