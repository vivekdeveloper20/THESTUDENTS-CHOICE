...
const categories: UniversityCategory[] = [
  ...
  },
  {
    ...
    bestFor: 'Computer Science, Engineering, AI, Co-op programs, industry partnerships',
  },
  {
    icon: '📈',
  ...
  },
  {
    ...
    bestFor: 'Affordable tuition, strong ROI, PR pathways, career support',
  },
];
...
export function CanadaPopularUniversitiesSection() {
  return (
