...
export interface StudyCanadaPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyCanadaPage(p: StudyCanadaPageProps) {
  return (
    <PageShell>
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to UofT, McGill & UBC' },
                    { icon: '🚀', text: '3-year post-study work permit' },
                    { icon: '🍁', text: 'Clear PR pathway via Express Entry' },
                    { icon: '💡', text: 'Affordable tuition & high quality' },
                    { icon: '🤝', text: '800,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Canada welcomes over <strong>800,000 international students</strong> annually and offers a <strong>clear pathway to permanent residency</strong> through Express Entry and PNP programs.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Canada Popular Universities ────────────────────────────── */}
      <CanadaPopularUniversitiesSection />
