...
const categories: UniversityCategory[] = [
  ...
  },
  {
    ...
    bestFor: 'Computer Science, Engineering, Data Analytics, AI, industry-linked programs',
  },
  {
    icon: '💻',
...
export function IrelandPopularUniversitiesSection() {
  return (
