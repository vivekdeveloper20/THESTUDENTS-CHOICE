...
import { WhyGermanyTopChoiceSection } from './WhyGermanyTopChoiceSection';
import { GermanyPopularUniversitiesSection } from './GermanyPopularUniversitiesSection';
...
export interface StudyGermanyPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyGermanyPage(p: StudyGermanyPageProps) {
  ...
  return (
    <PageShell>
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally recognised universities, affordable education, strong career opportunities, and innovation-driven learning in one of Europe's leading study destinations.
              </p>
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to TUM & RWTH Aachen' },
                    { icon: '🚀', text: 'Up to 18 months post-study work' },
                    { icon: '💰', text: 'Low or no tuition fees' },
                    { icon: '💡', text: 'Engineering & Technology Hub' },
                    { icon: '🤝', text: '450,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Germany is home to <strong>world-leading automotive brands</strong> like BMW, Mercedes-Benz, Volkswagen, and Audi — making it a <strong>global engineering powerhouse</strong> for students.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Germany Top Choice ──────────────────────────── */}
      <WhyGermanyTopChoiceSection />
      ...
      {/* ── Germany Popular Universities ────────────────────────────── */}
      <GermanyPopularUniversitiesSection />
