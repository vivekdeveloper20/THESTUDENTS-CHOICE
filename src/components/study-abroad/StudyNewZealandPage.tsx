...
import { WhyNewZealandTopChoiceSection } from './WhyNewZealandTopChoiceSection';
import { NewZealandPopularUniversitiesSection } from './NewZealandPopularUniversitiesSection';
...
export function StudyNewZealandPage(p: StudyNewZealandPageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally respected universities, practical learning, safe student-friendly cities, and strong post-study career opportunities in one of the world&apos;s most peaceful and innovative education destinations.
              </p>
              <Link
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    ...
                    { icon: '📜', text: 'Up to 3-year post-study work visa' },
                    { icon: '🌿', text: 'Ranked #2 on Global Peace Index' },
                    { icon: '🗣️', text: 'English-speaking education system' },
      ...
      {/* ── Why New Zealand Top Choice ──────────────────────────── */}
      <WhyNewZealandTopChoiceSection />
      ...
      {/* ── New Zealand Popular Universities ────────────────────────────── */}
      <NewZealandPopularUniversitiesSection />
