...
const categories: UniversityCategory[] = [
  ...
  },
  {
    ...
    bestFor: 'Engineering, Technology, Robotics, Automotive, industry partnerships',
  },
  {
    icon: '📈',
    ...
    bestFor: 'Fashion, Design, Architecture, Business, strong employability focus',
  },
  {
    icon: '💰',
...
export function ItalyPopularUniversitiesSection() {
  return (
