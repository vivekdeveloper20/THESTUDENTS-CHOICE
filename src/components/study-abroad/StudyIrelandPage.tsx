...
import { WhyIrelandTopChoiceSection } from './WhyIrelandTopChoiceSection';
import { IrelandPopularUniversitiesSection } from './IrelandPopularUniversitiesSection';
...
export interface StudyIrelandPageProps {
  country: string;
  tagline: string;
  heroImage: string;
...
export function StudyIrelandPage(p: StudyIrelandPageProps) {
  return (
    <PageShell>
      {/* ── Hero ───────────────────────────────────────── */}
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-28 w-full">
            ...
            >
              ...
              <p className="text-white/70 text-base md:text-xl font-semibold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                Discover globally respected universities, strong career opportunities, and a student-friendly environment in one of Europe's fastest-growing education destinations.
              </p>

              <Link
                href="/ireland-universities"
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <ul className="space-y-2.5">
                  {[
                    { icon: '🏆', text: 'Home to Trinity College Dublin & UCD' },
                    { icon: '🚀', text: '2-year post-study work visa' },
                    { icon: '🌐', text: 'English-speaking EU destination' },
                    { icon: '💡', text: 'European HQ of Google, Meta, Apple' },
                    { icon: '🤝', text: '35,000+ international students' },
                  ].map((pt, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                  Ireland is home to the <strong>European headquarters</strong> of Google, Meta, Apple, Microsoft, and LinkedIn — making it a <strong>global tech hub</strong> for students.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* ── Why Ireland Top Choice ──────────────────────────── */}
      <WhyIrelandTopChoiceSection />
      ...
      {/* ── Ireland Popular Universities ────────────────────────────── */}
      <IrelandPopularUniversitiesSection />
